...
set_target_properties(unofficial::shaderc::shaderc PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/shaderc.lib"
  )

list(APPEND _cmake_import_check_targets unofficial::shaderc::shaderc )
list(APPEND _cmake_import_check_files_for_unofficial::shaderc::shaderc "${_IMPORT_PREFIX}/debug/lib/shaderc.lib" )
...
set_target_properties(unofficial::shaderc::shaderc_util PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "CXX"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/lib/shaderc_util.lib"
  )

list(APPEND _cmake_import_check_targets unofficial::shaderc::shaderc_util )
list(APPEND _cmake_import_check_files_for_unofficial::shaderc::shaderc_util "${_IMPORT_PREFIX}/debug/lib/shaderc_util.lib" )

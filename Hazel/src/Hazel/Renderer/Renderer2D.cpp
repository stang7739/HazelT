...
namespace Hazel
{
    ...
    void Renderer2D::DrawQuad(const glm::vec3& position, const glm::vec2& size, const glm::vec4& color)
    {
        ...
        s_Data.QuadVertexBufferPtr->TexCoord = {0.0f, 0.0f}; // Default texture coordinates
        ...
        s_Data.QuadVertexBufferPtr->Color = color;
        s_Data.QuadVertexBufferPtr->TexCoord = {1.0f, 0.0f}; // Right bottom
        s_Data.QuadVertexBufferPtr->TexIndex = texIndex;
        s_Data.QuadVertexBufferPtr->TilingFactor = TilingFactor; // Default tilling factor
        s_Data.QuadVertexBufferPtr++;
        ...
        s_Data.QuadVertexBufferPtr->Color = color;
        s_Data.QuadVertexBufferPtr->TexCoord = {1.0f, 1.0f}; // Right bottom
        s_Data.QuadVertexBufferPtr->TexIndex = texIndex;
        s_Data.QuadVertexBufferPtr->TilingFactor = TilingFactor; // Default tilling factor
        s_Data.QuadVertexBufferPtr++;
        ...
        s_Data.QuadVertexBufferPtr->Color = color;
        s_Data.QuadVertexBufferPtr->TexCoord = {0.0f, 1.0f}; // Right bottom
        s_Data.QuadVertexBufferPtr->TexIndex = texIndex;
        s_Data.QuadVertexBufferPtr->TilingFactor = TilingFactor; // Default tilling factor
        s_Data.QuadVertexBufferPtr++;

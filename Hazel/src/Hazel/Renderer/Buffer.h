...
namespace Hazel
{
    ...
    struct BufferElement
    {
        ...
        ShaderDataType Type;
        uint32_t Size;
        uint32_t Offset = 0; // Offset in bytes from the start of the buffer
        bool Normalized;
        ...
        uint32_t GetCompoentCount() const
        {
            switch (Type)
            {
...
//initializer_list:Allows multiple BufferElement objects to be passed directly via {}
